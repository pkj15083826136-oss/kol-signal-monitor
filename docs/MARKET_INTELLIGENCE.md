...
- 默认提供商适配为 Whale Alert Alerts WebSocket，最低美元门槛固定为 `10,000,000`。
...
| --- | --- | --- | --- | --- |
| Whale Alert Alerts API | 交易双方归属、美元价格；能排除内部/同实体 | WebSocket 实时，官方称覆盖 100+ 资产、14 条链 | 需 API key；Alerts 计划公开价 USD 29.95/月，100 alerts/hour | 首选实时转账源；等待所有者购买/试用并配置密钥 |
