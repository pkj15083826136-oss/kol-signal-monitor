...
export type LiveMarketItem = BatchMarketItem & { directions: { price: MarketDirection; marketCap: MarketDirection; liquidity: MarketDirection; volume24h: MarketDirection } };
