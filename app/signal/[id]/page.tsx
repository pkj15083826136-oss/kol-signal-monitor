...
export default async function SignalDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initialMarket = { chain, address, price: livePrice, marketCap, liquidity, holders: market.holders, volume24h, updatedAt: new Date().toISOString(), source: livePrice > 0 || marketCap > 0 || liquidity > 0 || volume24h > 0 ? "server-market" : "unavailable" };
