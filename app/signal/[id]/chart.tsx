...
export default function SignalChart({ data, series, domain }: { data: Array<{ time: number; holders: number | null; value: number | null; amount: number | null }>; series: { holders: TrendSeriesPoint[]; amount: TrendSeriesPoint[]; value: TrendSeriesPoint[] }; domain: [number, number] }) {
  return <div className="h-80 w-full"><ResponsiveContainer width="100%" height="100%"><ComposedChart data={data} margin={{ top: 15, right: 10, left: -16, bottom: 0 }}><defs><linearGradient id="holders" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#67e8f9" stopOpacity={0.34}/><stop offset="100%" stopColor="#67e8f9" stopOpacity={0}/></linearGradient><linearGradient id="value" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#a78bfa" stopOpacity={0.24}/><stop offset="100%" stopColor="#a78bfa" stopOpacity={0}/></linearGradient></defs>
    ...
    <Area data={series.holders} yAxisId="holders" type="stepAfter" dataKey="value" name="KOL人数" connectNulls={false} stroke="#67e8f9" fill="url(#holders)" strokeWidth={2}/>
    <Area data={series.value} yAxisId="value" type="monotone" dataKey="value" name="持仓价值" connectNulls={false} stroke="#a78bfa" fill="url(#value)" strokeWidth={2}/>
